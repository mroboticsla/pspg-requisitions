...
import { Plus, Trash2, Edit2, Upload, FileText, ExternalLink } from 'lucide-react';
...
export default function ProfessionalProfileSections({ userId, onSectionChange }: Props) {
  ...
  useEffect(() => {
    ...
    [overviewRef, experienceRef, educationRef, skillsRef].forEach(ref => {
  ...
  return (
    <div className="space-y-6">
      {/* 1. Resumen y CV */}
      <section id="overview" ref={overviewRef} className="scroll-mt-6">
      ...
      {/* 4. Habilidades y Perfil Laboral */}
