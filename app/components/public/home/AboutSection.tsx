    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Acerca de PSP Group</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Fundada en 2010, PSP Group nació con la visión de transformar la manera en que las empresas encuentran talento y los
              profesionales descubren oportunidades.
            </p>
            <p className="text-gray-600 mb-4">
              A lo largo de los años, hemos construido relaciones sólidas con empresas líderes y profesionales destacados,
              estableciéndonos como referentes en el sector de reclutamiento ejecutivo.
            </p>
            <p className="text-gray-600 mb-6">
              Nuestro compromiso con la excelencia, la innovación y el servicio personalizado nos ha permitido crecer y adaptarnos
