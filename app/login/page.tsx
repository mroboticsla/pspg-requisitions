        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-surface-primary p-8 rounded-xl shadow-lg border border-neutral-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-gradient-to-r from-brand-accent to-brand-dark hover:from-brand-dark hover:to-brand-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-accent transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Iniciar Sesión
              </button>
            </form>
            ...
            <div className="mt-8 text-center">
              <p className="text-xs text-neutral-500">
                © 2024 PSP Group. Todos los derechos reservados.
              </p>
            </div>
          </div>
